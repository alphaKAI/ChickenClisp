...
class Engine {
  ...
  this() {
    ...
    this.variables.insert!("+",        "new Value(cast(IOperator)(new AddOperator))");
    this.variables.insert!("-",        "new Value(cast(IOperator)(new SubOperator))");
    this.variables.insert!("*",        "new Value(cast(IOperator)(new MulOperator))");
    this.variables.insert!("/",        "new Value(cast(IOperator)(new DivOperator))");
    this.variables.insert!("%",        "new Value(cast(IOperator)(new ModOperator))");
    this.variables.insert!("=",        "new Value(cast(IOperator)(new EqualOperator))");
    this.variables.insert!("<",        "new Value(cast(IOperator)(new LessOperator))");
    this.variables.insert!(">",        "new Value(cast(IOperator)(new GreatOperator))");
    this.variables.insert!("<=",       "new Value(cast(IOperator)(new LEqOperator))");
    this.variables.insert!(">=",       "new Value(cast(IOperator)(new GEqOperator))");
    this.variables.insert!("set",      "new Value(cast(IOperator)(new SetOperator))");
    this.variables.insert!("get",      "new Value(cast(IOperator)(new GetOperator))");
    this.variables.insert!("until",    "new Value(cast(IOperator)(new UntilOperator))");
    this.variables.insert!("step",     "new Value(cast(IOperator)(new StepOperator))");
    this.variables.insert!("if",       "new Value(cast(IOperator)(new IfOperator))");
    this.variables.insert!("!",        "new Value(cast(IOperator)(new NotOperator))");
    this.variables.link("not", "!");
    this.variables.insert!("&&",       "new Value(cast(IOperator)(new AndOperator))");
    this.variables.link("and", "&&");
    this.variables.insert!("||",       "new Value(cast(IOperator)(new OrOperator))");
    this.variables.link("or", "||");
    this.variables.insert!("print",    "new Value(cast(IOperator)(new PrintOperator))");
    this.variables.insert!("println",  "new Value(cast(IOperator)(new PrintlnOperator))");
    this.variables.insert!("def",      "new Value(cast(IOperator)(new DeffunOperator))");
    this.variables.insert!("while",    "new Value(cast(IOperator)(new WhileOperator))");
    this.variables.insert!("get-fun",  "new Value(cast(IOperator)(new GetfunOperator))");
    this.variables.insert!("lambda",   "new Value(cast(IOperator)(new LambdaOperator))");
    this.variables.insert!("map",      "new Value(cast(IOperator)(new MapOperator))");
    this.variables.insert!("set-idx",  "new Value(cast(IOperator)(new SetIdxOperator))");
    this.variables.insert!("as-iv",    "new Value(cast(IOperator)(new AsIVOperator))");
    this.variables.insert!("def-var",  "new Value(cast(IOperator)(new DefvarOperator))");
    this.variables.insert!("seq",      "new Value(cast(IOperator)(new SeqOperator))");
    this.variables.insert!("fold",     "new Value(cast(IOperator)(new FoldOperator))");
    this.variables.insert!("length",   "new Value(cast(IOperator)(new LengthOperator))");
    this.variables.insert!("car",      "new Value(cast(IOperator)(new CarOperator))");
    this.variables.insert!("cdr",      "new Value(cast(IOperator)(new CdrOperator))");
    this.variables.insert!("load",     "new Value(cast(IOperator)(new LoadOperator))");
    this.variables.insert!("cond",     "new Value(cast(IOperator)(new CondOperator))");
    this.variables.insert!("alias",    "new Value(cast(IOperator)(new AliasOperator))");
    this.variables.insert!("let",      "new Value(cast(IOperator)(new LetOperator))");
    this.variables.insert!("for-each", "new Value(cast(IOperator)(new ForeachOperator))");
    this.variables.insert!("remove",   "new Value(cast(IOperator)(new RemoveOperator))");
    this.variables.insert!("cons",     "new Value(cast(IOperator)(new ConsOperator))");
    this.variables.insert!("when",     "new Value(cast(IOperator)(new WhenOperator))");
    this.variables.insert!("list?",    "new Value(cast(IOperator)(new IsListOperator))");
    this.variables.insert!("make-hash",   "new Value(cast(IOperator)(new MakeHashOperator))");
    this.variables.insert!("set-value",   "new Value(cast(IOperator)(new SetValueOperator))");
    this.variables.insert!("get-value",   "new Value(cast(IOperator)(new GetValueOperator))");
    this.variables.insert!("define",      "new Value(cast(IOperator)(new DefineOperator))");
    this.variables.insert!("transpile",   "new Value(cast(IOperator)(new TranspileOperator))");
    this.variables.insert!("eval",        "new Value(cast(IOperator)(new EvalOperator))");
    this.variables.insert!("string-concat", "new Value(cast(IOperator)(new StringConcatOperator))");
    this.variables.insert!("string-join",   "new Value(cast(IOperator)(new StringJoinOperator))");
    this.variables.insert!("string-split",  "new Value(cast(IOperator)(new StringSplitOperator))"); 
  }
